...
namespace jQuery_Ajax_CRUD_MVC_Dialog_popup.Controllers
{
    public class TransactionController : Controller
    {
        ...
        {
            var tranx=_context.Transaction;
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("TransactionId,AccountNumber,BeneficiaryName,BankName,SWIFTCode,Amount")] Transaction transaction)
        {
